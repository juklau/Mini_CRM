...
{
    let insertion = `
        <div class="container bg-white border border-black col-11 col-md-8 col-xl-6">
            <div class="modulo position-fixed bg-white p-2 rounded-3 text-center border border-black" id="profil-Modulo" >
                <div class="modulo-content d-flex align-items-center justify-content-around">
                    ...
                    <div class="btn-container buttons my-4 d-flex flex-column ms-5">
                        <button class="modulo-btn btn btn-outline-secondary btn border border-2 rounded" id="upload-btn"><i class="fa-solid fa-pen" title="Modifier"></i></button>
                        <button class="modulo-btn btn btn-outline-secondary btn border border-2 rounded" id="remove-btn"><i class="fa-solid fa-trash" title="Supprimer"></i></button>
                    </div>
                </div>
                    ...
                    <div class="col-12 col-sm-10">
                        <div class="row align-items-center mb-sm-3">
                            ...
                            <div class="col-12 col-sm-8">
                                ...
                                <small id="small-nom" class="text-danger"></small>
                            </div>
                        </div> 
                    </div>
                </div> 
                    ...
                    <div class="col-12 col-sm-10">
                        <div class="row align-items-center mb-sm-2">
                            ...
                            <div class="col-12 col-sm-8">
                                ...
                                <small id="small-prenom" class="text-danger"></small>
                            </div>
                        </div> 
                    </div>
                </div> 
                    ...
                    <div class="col-12 col-sm-10">
                        <div class="row align-items-center mb-sm-2">
                            ...
                            <div class="col-12 col-sm-8">
                                ...
                                <small id="small-entreprise" class="text-danger"></small>    
                            </div>
                        </div> 
                    </div>
                </div> 
                    ...
                    <div class="col-12 col-sm-10">
                        <div class="row align-items-center mb-sm-2">
                            ...
                            <div class="col-12 col-sm-8">
                                ...
                                <small id="small-email" class="text-danger"></small>    
                            </div>
                        </div> 
                    </div>
                </div> 
                    ...
                    <div class="col-12 col-sm-10">
                        <div class="row align-items-center mb-sm-2">
                            ...
                            <div class="col-12 col-sm-8">
                                ...
                                <small id="small-tel" class="text-danger"></small>    
                            </div>
                        </div> 
                    </div>
                </div> 
                    ...
                    <div class="col-12 col-sm-10">
                        <div class="row align-items-center mb-sm-2">
                            ...
                            <div class="col-12 col-sm-8">
                                ...
                                <small id="small-type-contact" class="text-danger"></small>
                            </div>
                        </div> 
                    </div>
                </div> 
                    ...
                    <div class="col-12 col-sm-10">
                        <div class="row align-items-center mb-sm-2">
                            ...
                            <div class="col-12 col-sm-8">
                                ...
                                <small id="small-date" class="text-danger"></small>
                            </div>
                        </div> 
                    </div>
                </div> 
                    ...
                    <div class="col-12 col-sm-10">
                        <div class="row align-items-center mb-sm-2">
                            ...
                            <div class="col-12 col-sm-8">
                                ...
                                <small id="small-note" class="text-danger"></small>
                            </div>
                        </div> 
                    </div>
                </div> 
